...
function RegisterStudent($username,$password,$ip_address,$time,$date,$us,$s_id,$grade,$addr,$fat,$mot,$dobbs,$dobad,$fname,$lname,$gender){
	$counts=0;
...
function RegisterTeacher($username,$password,$ip_address,$time,$date,$us,$s_id,$grade,$addr,$fat,$mot,$dobbs,$dobad,$fname,$lname,$gender){
	$counts=0;
...
function RegisterStaff($username,$password,$ip_address,$time,$date,$us,$s_id,$grade,$addr,$fat,$mot,$dobbs,$dobad,$fname,$lname,$gender){
	$counts=0;
