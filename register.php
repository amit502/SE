...
if(isset($_POST['reg_teacher'])){
	...
	elseif($reg->GetUserInfo($username)){
		...
		$stat=$reg->RegisterUsers($username,$password,$ip_address,$time,$date,$_SESSION['user_stat'],$hsh,$_POST['grade'],$_POST['addr'],$_POST['fat'],$_POST['mot'],$_POST['dobbs'],$_POST['dobad'],$_POST['fname'],$_POST['lname'],$_POST['gender']);
		if($stat==1){
			$make_sessions=$reg->GetUserInfo($username);
			foreach($make_sessions as $userSessions)
			{
